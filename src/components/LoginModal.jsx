            ...
            <DialogTitle id="responsive-dialog-title" style={{ padding: "0px", position: 'relative', height: "80vh" }}>
                ...
                <div className='d-flex justify-content-center flex-column align-items-center'>
                    ...
                    <div style={{ position: "relative", margin: "20px 0" }} >
                        <div >
                            <input type='text' placeholder='Correo electronico*' style={inputStyle} />
                        </div>
                    ...
                    <div style={btnStyle}>Ingresar</div>
                    <div style={smallText}>¿Has olvidado tu contraseña?</div>
                    <br />
                    <div className='d-flex align-items-center justify-content-center'>
                        <div style={{ width: "98px", height: "2px", background: 'var(--Basic_Red, #E52823)' }}></div>
                        <div style={smallText}>Continuar con</div>
                    ...
                    <div className='d-flex justify-content-around'>
                        <div style={boxStyle}>
                            <div><img width={31.23} height={30.23} src={Google} /></div>
                            <div style={text}>
                                GOOGLE
                            </div>
                        </div>
                        <div style={boxStyle}>
                            <div><img width={31.23} height={30.23} src={FB} /></div>
                            <div style={text}>
                                FACEBOOK
                            </div>
                        </div>
                    </div>
                    <div style={redText} >Crear cuenta nueva</div>
                </div>
